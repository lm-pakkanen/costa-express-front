...
const HeroBackground: React.FC = () => {
  ...
  const backgroundMobile: IImage = {
    url: getHref("/img/Landing_mobile-675x1125-80.jpg").toString(),
    alt: "",
    title: "CostaExpress",
  };

  const backgroundDesktop: IImage = {
    url: getHref("/img/Landing_desktop-2000x1125-80.jpg").toString(),
    alt: "",
    title: "CostaExpress",
  };

  const backgroundDesktopLarge: IImage = {
    url: getHref("/img/Landing_desktop-3000x1687-80.jpg").toString(),
    alt: "",
    title: "CostaExpress",
  };
  ...
  if (width <= 650 && height <= 1100) {
    ...
    return (
      <div className={styles.HeroBackgroundDesktopLarge}>
        <img
          src={backgroundDesktopLarge.url}
...
const HeroLogo: React.FC<IHeroLogo> = () => {
  const logo: IImage = {
    url: getHref("/img/LogoV1.svg").toString(),
    alt: "CostaExpress",
    title: "CostaExpress",
  };
  ...
  return (
    <div className={styles.HeroLogo}>
      ...
      <h2 className={styles.Slogan}>Muuttaa kaiken!</h2>
    </div>
  );
};
